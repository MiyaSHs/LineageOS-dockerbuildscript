...
this should also be adaptable into building a rom thats not LineageOS, or even LineageOS based, but it would require editing the docker image and i will not help with it.
